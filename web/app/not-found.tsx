  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "#F5F6F4" }}>
      <div className="bg-white rounded-2xl border p-10 text-center max-w-md" style={{ borderColor: "#E3E6E2" }}>
        <div className="text-4xl font-bold mb-2" style={{ fontFamily: "var(--font-sora)", color: "var(--brand-accent,#0E6B5C)" }}>404</div>
        ...
        <Link href="/dashboard" className="inline-block px-6 py-2.5 rounded-xl text-white font-semibold text-sm" style={{ background: "var(--brand-accent,#0E6B5C)" }}>
