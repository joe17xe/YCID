...
const IMPORT_TYPES: Record<ImportKind, { label: string; columns: string[]; required: string[] }> = {
  ...
  budget: {
    ...
    columns: ["projet", "poste", "categorie", "montant_previsionnel", "description", "financeur", "organisation_responsable", "phase", "tache", "montant_tache", "annee", "valorisation", "statut", "commentaire"],
